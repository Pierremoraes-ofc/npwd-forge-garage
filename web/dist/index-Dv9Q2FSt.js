import { g as T } from "./_commonjsHelpers-C932wzq6.js";
var C = { exports: {} }, r = {};
/**
* @license React
...
function p(e, t, n) {
  this.props = e, this.context = t, this.refs = j, this.updater = n || b;
}
...
var R = Array.isArray, O = Object.prototype.hasOwnProperty, E = { current: null }, P = { key: true, ref: true, __self: true, __source: true };
function I(e, t, n) {
  var u, o = {}, c = null, s = null;
  if (t != null) for (u in t.ref !== void 0 && (s = t.ref), t.key !== void 0 && (c = "" + t.key), t) O.call(t, u) && !P.hasOwnProperty(u) && (o[u] = t[u]);
...
function _(e, t, n, u, o) {
  ...
  if (s) return s = e, o = o(s), e = u === "" ? "." + v(s, 0) : u, R(o) ? (n = "", e != null && (n = e.replace($, "$&/") + "/"), _(o, t, n, "", function(a) {
    return a;
  })) : o != null && (k(o) && (o = W(o, n + (!o.key || s && s.key === o.key ? "" : ("" + o.key).replace($, "$&/") + "/") + e)), t.push(o)), 1;
  if (s = 0, u = u === "" ? "." : u + ":", R(e)) for (var f = 0; f < e.length; f++) {
    c = e[f];
    var i = u + v(c, f);
    s += _(c, t, n, i, o);
  }
  else if (i = H(e), typeof i == "function") for (e = i.call(e), f = 0; !(c = e.next()).done; ) c = c.value, i = u + v(c, f++), s += _(c, t, n, i, o);
...
var l = { current: null }, h = { transition: null }, K = { ReactCurrentDispatcher: l, ReactCurrentBatchConfig: h, ReactCurrentOwner: E };
function D() {
...
r.cloneElement = function(e, t, n) {
  ...
  if (t != null) {
    if (t.ref !== void 0 && (c = t.ref, s = E.current), t.key !== void 0 && (o = "" + t.key), e.type && e.type.defaultProps) var f = e.type.defaultProps;
    for (i in t) O.call(t, i) && !P.hasOwnProperty(i) && (u[i] = t[i] === void 0 && f !== void 0 ? f[i] : t[i]);
  }
...
r.createContext = function(e) {
  return e = { $$typeof: L, _currentValue: e, _currentValue2: e, _threadCount: 0, Provider: null, Consumer: null, _defaultValue: null, _globalName: null }, e.Provider = { $$typeof: q, _context: e }, e.Consumer = e;
};
r.createElement = I;
